  ...
  files.forEach(function (file) {
    it('can parse ' + file, () => {
      ...
      if (fs.existsSync(jsFile)) {
        ...
        expect(JSON.stringify(ret)).to.equal(JSON.stringify(js))
...
describe('packet', () => {
  describe('Response', () => {
    ...
    it('should only support STAT_TYPE and CHALLENGE_TYPE', () => {
  ...
  describe('Request', () => {
    it('should generate valid sessinIds', () => {
    ...
    it('should create a challenge token', () => {
    ...
    it('packet with bad type', () => {
      expect(fn).to.throw(Error)
      function fn () {
        let p = new RequestPacket(999)
        expect(p.type).to.equal(0)
      }
    })

    it('should not write bad type', () => {
    ...
    it('should not write bad sessionId', () => {
      var p = new RequestPacket()
      p.sessionId = 0
    ...
    it('should not write bad payload', () => {
      var p = new RequestPacket()
      p.payload = 'asdf'
    ...
    it('should not write STAT without challengeToken', () => {
      var p = new RequestPacket(consts.REQUEST_BASIC)
    ...
    it('should not parse anything but STAT_TYPE', () => {
