...
var RequestPacket = module.exports = function (requestType, options) {
  ...
  switch (requestType) {
    ...
    case consts.REQUEST_FULL:
      this.payload = options.payload || Buffer.from([0, 0, 0, 0])
...
RequestPacket.write = function (packet) {
  ...
  var pLength = typeof packet.payload === 'undefined' ? 0 : packet.payload.length

  var sLength = typeof packet.challengeToken !== 'number' ? 0 : 4

  var bc = new BufferCursor(Buffer.alloc(7 + sLength + pLength))
